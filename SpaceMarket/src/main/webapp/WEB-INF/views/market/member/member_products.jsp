		...
		<div class="row">
				...
				<div class="sidebar">
					...
					<div class="widget user-dashboard-menu">
						<ul>
							...
							<li>
								<a href="/market/member/favoriteProducts?member_id=<%=thisMember.getMember_id()%>"><i class="fa fa-bookmark-o"></i> 좋아요한 상품 <span></span></a>
							</li>
			...
			<div class="col-md-10 offset-md-1 col-lg-8 offset-lg-0">
				...
				<div class="widget dashboard-container my-adslist">
					<h3 class="widget-header">내 상품</h3>
					<table class="table table-responsive product-dashboard-table">
						...
						<tbody>
							<%for(Product product : thisMember.getProductList()) {%>
								<tr id="<%=product.getProduct_id() %>">
										...
										<div class="">
											<ul class="list-inline justify-content-center">
												<li class="list-inline-item">
													<a data-toggle="tooltip" data-placement="top" title="상품보러가기" class="view" href="/market/product/detail?product_id=<%=product.getProduct_id()%>">
														<i class="fa fa-eye"></i>
													</a>
												</li>
												<%if(member.getMember_id()==thisMember.getMember_id()){ %>
												<li class="list-inline-item" >
													<a data-toggle="tooltip" data-placement="top" title="판매중지" class="edit"  href="javascript:saleStop(<%=product.getProduct_id()%>)">
